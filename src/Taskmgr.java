 ...
 * @author Usuario
 */
public class Taskmgr extends javax.swing.JFrame {
...
setVisible(true);
    ...
    private void initComponents() {
        ...
        mssettings1 = new javax.swing.JLabel();
        ...
        mssettings.setText("Pestaña de GPU");
        mssettings.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                mssettingsMouseClicked(evt);
            }
        });
        jPanel1.add(mssettings, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 910, -1, 50));

        mssettings1.setBackground(new java.awt.Color(187, 187, 187));
        mssettings1.setFont(new java.awt.Font("Arial Black", 0, 24)); // NOI18N
        mssettings1.setText("Resumen de Entrada/Salida");
        mssettings1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                mssettings1MouseClicked(evt);
            }
        });
        jPanel1.add(mssettings1, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 830, -1, 50));

        Control.setBackground(new java.awt.Color(187, 187, 187));
        Control.setFont(new java.awt.Font("Arial Black", 0, 24)); // NOI18N
        Control.setText("Administrador de servicios");
        ...
        flush.setText("Administrador de detalles");
        ...
        mmsys.setText("Administrador de usuarios");
        ...
        systempropierties.setText("Administrador de arranque");
        ...
        Msconfig.setText("Administrador de aplicaciones");
        ...
        Cleanmgr.setText("Administrador de rendimiento");
        ...
        Temporales.setText("Administrador de tareas");
        ...
        Musica.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Administrador de tareas logo.png"))); // NOI18N
  ...
  try {
    Runtime.getRuntime().exec("cmd /c start taskmgr.exe /0");
    ...
    private void CleanmgrMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CleanmgrMouseClicked
      try {
    Runtime.getRuntime().exec("cmd /c start taskmgr /Performance");
} catch (IOException ex) {
    ex.printStackTrace();    }      // TODO add your handling code here:
    ...
    private void MsconfigMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_MsconfigMouseClicked
          try {
    Runtime.getRuntime().exec("cmd /c start taskmgr /Procesess");
} catch (IOException ex) {
    ex.printStackTrace();    }    // TODO add your handling code here:
    ...
    private void systempropiertiesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_systempropiertiesMouseClicked
       try {
    Runtime.getRuntime().exec("cmd /c start taskmgr /Services");
} catch (IOException ex) {
    ex.printStackTrace();    }       // TODO add your handling code here:
    ...
    private void mmsysMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mmsysMouseClicked
        try {
    Runtime.getRuntime().exec("cmd /c start taskmgr /AppHistory");
} catch (IOException ex) {
    ex.printStackTrace();    }     // TODO add your handling code here:
    ...
    try {
    Runtime.getRuntime().exec("cmd /c start taskmgr /Startup");
} catch (IOException ex) {
    ex.printStackTrace();    }      // TODO add your handling code here:
    ...
    private void mssettingsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mssettingsMouseClicked
         try {
    Runtime.getRuntime().exec("cmd /c start taskmgr /Run");
} catch (IOException ex) {
    ex.printStackTrace();    }         // TODO add your handling code here:
    }//GEN-LAST:event_mssettingsMouseClicked

    private void mssettings1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mssettings1MouseClicked
        try {
    Runtime.getRuntime().exec("cmd /c start taskmgr.exe /8");
} catch (IOException ex) {
    ex.printStackTrace();    }     // TODO add your handling code here:
    }//GEN-LAST:event_mssettings1MouseClicked
    ...
    private javax.swing.JLabel mssettings1;
